...
class UnvotedUser extends StatefulWidget {
  UnvotedUser({Key? key}) : super(key: key);

 @override
 State<UnvotedUser> createState() => _UnvotedUserState();
}
class _UnvotedUserState extends State<UnvotedUser>{
  List userdata=[];
  Future<List> getrecord() async{
    String url = "$uri/voting/php/unvoteduser.php/";
