...
class TotalVoter extends StatefulWidget {
  TotalVoter({Key? key}) : super(key: key);

 @override
 State<TotalVoter> createState() => _TotalVoterState();
}
class _TotalVoterState extends State<TotalVoter>{
  List userdata=[];
